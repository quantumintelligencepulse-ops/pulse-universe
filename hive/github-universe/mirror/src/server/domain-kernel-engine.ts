...
export async function startDomainKernelEngine(): Promise<void> {
  ...
  // 2026-04-27 RESTORE: all intervals 2x original, stagger 2.5x, to fit 20-conn pool
  // shared with spawn/quantapedia/ingestion/hospital/omni-net engines.
  const kernels: Array<{ fn: () => Promise<void>; interval: number; name: string }> = [
    { fn: runQuantapediaKernel,  interval: 24000,  name: "Quantapedia"   },
    { fn: runProductsKernel,     interval: 30000,  name: "Products"      },
    { fn: runCareersKernel,      interval: 40000,  name: "Careers"       },
    { fn: runMediaKernel,        interval: 50000,  name: "Media"         },
    { fn: runHiveMemoryKernel,   interval: 36000,  name: "HiveMemory"    },
    { fn: runPulseUKernel,       interval: 44000,  name: "PulseU"        },
    { fn: runNewsKernel,         interval: 32000,  name: "News"          },
    { fn: runSocialKernel,       interval: 60000,  name: "Social"        },
    { fn: runGamesKernel,        interval: 56000,  name: "PulseWorld"    },
    { fn: runFinanceKernel,      interval: 28000,  name: "Finance"       },
    { fn: runScienceKernel,      interval: 38000,  name: "Science"       },
    { fn: runMusicKernel,        interval: 70000,  name: "Music"         },
    { fn: runGovernmentKernel,   interval: 64000,  name: "Government"    },
    { fn: runEngineeringKernel,  interval: 52000,  name: "Engineering"   },
    { fn: runLegalKernel,        interval: 46000,  name: "Legal"         },
    { fn: runCultureKernel,      interval: 76000,  name: "Culture"       },
    { fn: runEconomicsKernel,    interval: 48000,  name: "Economics"     },
    { fn: runHealthKernel,       interval: 42000,  name: "Health"        },
    { fn: runWebKernel,          interval: 34000,  name: "WebCrawl"      },
    { fn: runGeospatialKernel,   interval: 58000,  name: "Geospatial"    },
    { fn: runAIResearchKernel,   interval: 26000,  name: "AIResearch"    },
    { fn: runFrontierKernel,     interval: 66000,  name: "Frontier"      },
    { fn: runOmegaFamiliesKernel,interval: 16000,  name: "OmegaFamilies" },
  ];
  ...
  // Mutation engine — every 16 minutes (was 8), a new business that didn't exist before
  setTimeout(() => {
    runMutationEngine().catch(() => {});
    setInterval(() => runMutationEngine().catch(() => {}), 960000);
  }, 90000);
